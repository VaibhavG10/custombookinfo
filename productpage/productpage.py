...
# Add on 25th Feb, dynamic URL & port option. URL must be without http
PROTOCOL_TYPE=os.environ.get('PROTOCOL_TYPE', "http")
DETAILS_URL=os.environ.get('DETAILS_URL', "details{0}")
DETAILS_PORT=os.environ.get('DETAILS_PORT', "9080")

details = {
    "name" : (PROTOCOL_TYPE+"://"+DETAILS_URL+":"+DETAILS_PORT).format(servicesDomain),
    "endpoint" : "details",
    "children" : []
}

RATINGS_URL=os.environ.get('RATINGS_URL', "ratings{0}")
RATINGS_PORT=os.environ.get('RATINGS_PORT', "9080")

ratings = {
    "name" : (PROTOCOL_TYPE+"://"+RATINGS_URL+":"+RATINGS_PORT).format(servicesDomain),
    "endpoint" : "ratings",
    "children" : []
}

REVIEWS_URL=os.environ.get('REVIEWS_URL', "reviews{0}")
REVIEWS_PORT=os.environ.get('REVIEWS_PORT', "9080")

reviews = {
    "name" : (PROTOCOL_TYPE+"://"+REVIEWS_URL+":"+REVIEWS_PORT).format(servicesDomain),
    "endpoint" : "reviews",
    "children" : [ratings]
}
